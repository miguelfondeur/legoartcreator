        ...
        case 'updateSettings':
            ...
            Object.keys(message.settings).forEach(key => {
                if (project.settings.hasOwnProperty(key)) {
                    if (key === 'rotation') {
                        project.settings.rotation = (project.settings.rotation + message.settings.rotation + 360) % 360;
                    } else if (key !== 'flippedHorizontal' && key !== 'locked') {
                        project.settings.flippedHorizontal = message.settings.flippedHorizontal;
                    } else {
