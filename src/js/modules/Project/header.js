            ...
            <header class="flex items-center bg-white w-full h-[56px] absolute left-0 z-50 border-b text-zinc-200">
                ...
                <div class="flex items-center text-sm gap-2 px-4 text-black">
                    ...
                    <button project-page-id="instructions"
                            ...
                            class="min-w-[36px] hover:bg-gray-100 px-2 md:px-4 py-2 rounded-full inline-flex items-center justify-center text-sky-700 disabled:pointer-events-none disabled:border-gray-200 disabled:text-gray-300 transition-all shadow hover:shadow-md"
                    >
                        <svg class="w-5 md:mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                        </svg>
                        <span class="hidden md:block">Instuctions</span>
                    </button>
                </div>
            </header>`
    }
    ...
    updateActiveLink(activePage) {
        ...
        links.forEach(link => {
            if (link.getAttribute('project-page-id') === activePage) {
                link.classList.add('bg-sky-600','hover:bg-sky-600','!text-white');
