(() => {
  ...
  var sharedEventDispatcher_default = sharedEventDispatcher;

  // <stdin>
  var ProjectHeader = class extends HTMLElement {
    //Teamplte
    render() {
      this.innerHTML = `
    ...
    connectedCallback() {
      ...
      sharedEventDispatcher_default.addEventListener("finishProject", (e) => {
